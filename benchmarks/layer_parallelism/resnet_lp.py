...
if(MODEL_TYPE==1):
	...
	model = resnet_cifar_torch.get_resnet_v2((int(batch_size / parts), 3, image_size_seq, image_size_seq), depth=get_depth(2, 12))
elif(MODEL_TYPE==2):
...
if(MODEL_TYPE==1):
	model = resnet_cifar_torch.get_resnet_v2((int(batch_size/parts),3,image_size,image_size),get_depth(1,resnet_n))
elif(MODEL_TYPE==2):
