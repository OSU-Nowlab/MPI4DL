...
model = resnet_cifar_torch.get_resnet_v2((int(batch_size / parts), 3, image_size_seq, image_size_seq), depth=get_depth(2, resnet_n))
...
model = resnet_cifar_torch.get_resnet_v2((int(batch_size/parts),3,image_size,image_size),get_depth(2, resnet_n))
